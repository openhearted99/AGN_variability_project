...
#general inputs
name="example_results"     # What resulting files will be named
repetitions=1             # How many light curves will be generated

#codes inputs
LClength_in=28             # 2^(LClength_in) points will be used for each lightcurve
