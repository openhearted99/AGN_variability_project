...
#general inputs
name="PDF_in_gets_0"     # What resulting files will be named
...
LowerLimit_in=0.001      # Lower limit of the PDF for the random draw algorithm.
                           # Must be < LowerLimit_acc_in if PDF_in=1, and = LowerLimit_acc_in
                           # for log-normal case
UpperLimit_in=3.          # Upper limit of the PDF for the random draw algorithm.
...
delta2_BPL_in=2.53         # High-Eddington ratio slope
lambda_s_BPL_in=0.01445    # Break Eddington ratio, where the power law bends
#-------------
PDF_in=0                   # Determines whether you use a broken power law or log-normal description of the PDF.
