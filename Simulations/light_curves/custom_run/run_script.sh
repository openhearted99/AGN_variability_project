...
#general inputs
name="custom_run_7.27.2019"# What resulting files will be named
...
tbin_in=2.632e6            # Resolution of light curve (dt), in seconds
#-------------
A_in=30                    # Dummy variable used for normalization
v_bend_in=1.e-9           # Frequency of the bend of the power-law
...
lambda_s_BPL_in=0.11       # Break Eddington ratio, where the power law bends
#-------------
